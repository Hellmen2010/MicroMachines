...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    public class DynamicContent : MonoBehaviour
    {
        ...
        public int GetSelectedPanel() => scrollSnap.SelectedPanel;
        public int GetCenteredPanel() => scrollSnap.CenteredPanel;

        public GameObject Add(int index, GameObject prefabGO)
        {
            // Pagination
            ...
            //ТО ЧТО МЫ СОЗДАЕМ
            return scrollSnap.Add(prefabGO, index);
        }
